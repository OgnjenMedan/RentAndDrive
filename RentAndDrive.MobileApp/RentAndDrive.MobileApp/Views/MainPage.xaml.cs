...
using RentAndDrive.MobileApp.Models;
...
namespace RentAndDrive.MobileApp.Views
{
    ...
    public partial class MainPage : MasterDetailPage
    {
        ...
        public MainPage()
        {
            ...
            MenuPages.Add((int)MenuItemType.Automobili, (NavigationPage)Detail);
        }
            ...
            if (!MenuPages.ContainsKey(id))
            {
                switch (id)
                {
                    ...
                    case (int)MenuItemType.Rezervacije:
                        ...
                        break;
                    case (int)MenuItemType.IstorijaRezervacija:
                        MenuPages.Add(id, new NavigationPage(new RezervacijePage(true)));
                        break;
